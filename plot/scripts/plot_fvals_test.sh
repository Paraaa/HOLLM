...
blacklist="ASHA,ASHABORE,ASHACQR,BOHB,growth-rate,alpha-0.2,alpha-0.5,alpha-0.7,LLMKD-growth-rate-0,LLMKD-growth-rate-0.2,LLMKD-growth-rate-0.5,LLMKD-growth-rate-0.7"
...
python ./plot/$script \
        ...
        --columns "F1" \
        --trials 100 \
        --data_path ./results/SyneTune/levy_1/ \
        --filename "fvals_levy" \
        --normalization_method "none" \
        --blacklist $blacklist \
        --use_log_scale "False" \
