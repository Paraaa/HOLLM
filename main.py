...
def main():
    ...
    parser.add_argument(
        ...
        type=str,
        default="gemma_2b_it",
        help="Choose which model to use (default: gemma)",
    )
    parser.add_argument(
        "--alpha",
        type=float,
    ...
    parser.add_argument(
        ...
        type=str,
        default="NB201",
        help="The benchmark (previously called 'bbox_eval_f')to evaluate on (default: 5)",
    )
    parser.add_argument(
        "--method_name",
        type=str,
    ...
    parser.add_argument(
        ...
        type=str,
        default="mooLLM",
        help="The optimization method to be used (default: mooLLM)",
    )
    ...
    parser.add_argument(
        ...
        type=str,
        default="mooLLM_SUR",
        help="The surrogate model to use (default: mooLLM_SUR)",
    )
    parser.add_argument(
        "--candidate_sampler",
        type=str,
    ...
    mooLLM_builder = Builder(config=config, benchmark=benchmark)
    mooLLM = mooLLM_builder.build()

    statistics = mooLLM.optimize()

    total_time_taken = mooLLM.statistics.total_time_taken
    logger.debug(
