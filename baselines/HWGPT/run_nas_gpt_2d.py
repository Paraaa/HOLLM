...
if __name__ == "__main__":
    ...
    parser.add_argument("--objective", type=str, default="latencies")
    ...
    for trial, trial_df in df.groupby("trial_id"):
        ...
        perplexity.append(trial_df["perplexity"].values[0])
        energy.append(trial_df["hw_metric"].values[0])
        config = {}
    ...
    objective_path = method_path + args.objective + "/"
    ...
    if (
        ...
        save_path = objective_path + args.experiment_tag + ".pickle"
    else:
        save_path = f"{objective_path}{args.method}_{args.objective}_{args.device}_{args.random_seed}"
